...
from seis2rock.elastic import Elastic
from seis2rock.bounds import _percent_check, voigt_bound, \
...
class Matrix():
    ...
    def __init__(self, minerals):
        ...
        self.mus = np.array([value['mu'] for value in fracs])#Modifiying
    ...
    @property #Adding all the property
    def mu(self):
        self._mu = voigt_reuss_hill_average(self.fracs, self.mus)
        return self._mu
